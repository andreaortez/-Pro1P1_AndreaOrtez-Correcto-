...
public class ModificarCancion extends javax.swing.JFrame {
    ...
    public void Llenar() {
        info = Pro1P1_AndreaOrtez.lista.get(indice);
        
        cancion.setText(info.getCancion());
        album.setText(info.getAlbum());
        artista.setText(info.getArtista());
        año.setText(Integer.toString(info.getAño()));
        duracion.setText(Integer.toString(info.getDuracion()));
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 280, -1, -1));
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
        ...
        Pro1P1_AndreaOrtez.lista.set(indice + 1, info);
        JOptionPane.showMessageDialog(null, "¡CANCIÓN MODIFICADA CON ÉXITO!");
